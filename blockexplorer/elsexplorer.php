...
function get_n_coins($blocks) {
  ...
  return '<span title="'.number_format($coins).'">'.round($coins/1000000).'M</span>';
}
...
echo '<a href="' . COIN_HOME . '" title="'. COIN_NAME .' Home"><img src="img/elysium-logo.jpg" style="width:60px;height:60px;border-radius:50%;box-shadow: -1px -1px 8px 10px rgba(0,255,0,0.5);margin-bottom: 20px;"></a><table><tr><td class="urgh"><b><a href="elsexplorer.php">' . COIN_NAME . '</a></b> block explorer</td><td>Blocks:</td><td><a href="?' . $ace['num_blocks'] . '">' . $ace['num_blocks'] . '</a>';
$diffNom = 'Difficulty';
...
if( isset($ace['blocks']) )
{
    echo "<table><tr><td><b>Block</b></td><td><b>Hash</b></td><td><b>Diff</b></td><td><b>Time (UTC)</b></td><td><b>Tx&middot;Value</b></td></tr><tr><td colspan=\"5\"></td></tr>";
...
elseif( isset($ace['transactions']) )
{
    ...
    {
        echo "<tr><td class=\"key\">tx</td><td class=\"value\">{$tx['id']}<br>Coins: {$tx['sellcoin']}</td></tr>";
...
echo '</div>
<center><a href="http://elysiumcoin.org/" style="font-size:12px;position:relative;bottom: -12px;">Block Explorer Hosted by Elysium Coin ORG</a></cemter></body></html><br><br>'
?>
