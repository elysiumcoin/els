...
{
    return GetBoolArg("-testnet", false) ? 20498 : 10498;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Elysium server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: elysium-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use elysiumd";
