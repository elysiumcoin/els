...
See `doc/readme-qt.rst` for instructions on building Elysium-Qt, the
...
on an OS X 10.6 64-bit machine fails. Official release builds of Elysium-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `Elysium-Qt.app` is easy:
